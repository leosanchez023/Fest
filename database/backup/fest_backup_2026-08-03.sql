...
CREATE TABLE `pedidos` (
  ...
  `status` enum('ORCAMENTO','CONFIRMADO','EM_PREPARO','ENTREGUE','RETIRADO','CONFERENCIA','PENDENTE','FINALIZADO','CANCELADO') DEFAULT 'ORCAMENTO',
...
-- Dump completed on 2026-08-03  1:35:22
